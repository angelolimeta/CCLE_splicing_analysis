---
title: "Drug  sensitivity - TCGA no core splicing factors"
...
```{r}
no_keep <- c("Engineered", "Embryonal Cancer", "Teratoma", "Prostate Cancer", "NA", "Liposarcoma", "Thyroid Cancer", "Eye Cancer", "Neuroblastoma", "Fibroblast", "Gallbladder Cancer")
...
ggplot(plotData_gg, aes(x = PC1,y = PC2, color = spliceosome_mutated)) +
  ...
  ggsave("/Users/castilln/Desktop/thesis/figures/tcga_no_core_gg_drug_mutation.png", device = "png", width = 25, height = 15, units = "cm", dpi = "retina")
...
ggplot(plotData_gg, aes(x = PC1,y = PC2, color = primary_disease)) +
  ...
  ggsave("/Users/castilln/Desktop/thesis/figures/tcga_no_core_gg_drug_disease.png", device = "png", width = 25, height = 15, units = "cm", dpi = "retina")
...
ggsave("/Users/castilln/Desktop/thesis/figures/no_core_tcga_tsne_drug.png", device = "png", width = 30, height = 25, units = "cm", dpi = "retina")
