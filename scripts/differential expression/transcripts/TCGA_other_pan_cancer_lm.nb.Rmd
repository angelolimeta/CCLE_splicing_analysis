---
title: "Linear model for transcription expression data on multiple cancers - using TCGA splicing factors classified as `other`". 
...
Save lm_res
```{r}
saveRDS(lm_res_symbols, file = "/Users/castilln/Desktop/thesis/github/results/differential_expression/transcripts/tcga_other_spliceosome_lm_res_symbols.rds")
```