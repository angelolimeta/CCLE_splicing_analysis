---
title: "Lancaster method for linear model results / term pancreatic cancer"
...
```{r}
lm_res = readRDS("../github/results/differential_expression/transcripts/tcga_non_core_spliceosome_lm_res_symbols.rds")
...
```{r}
no_keep <- c("Adrenal Cancer", "Embryonal Cancer", "Non-cancerous", "Teratoma")
...
```{r}
saveRDS(all_p.val, file = "res_lancaster/nocore_tcga_p_values_lancaster.rds")
```
