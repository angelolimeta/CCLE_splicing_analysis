...
```{r}
lanc_p_values = readRDS("localdata/res_lancaster/nocore_tcga_p_values_lancaster.rds")
...
```{r, include=FALSE}
GSAsummaryTable(gsaRes = gsa_adj_kegg, save=T, file = "localdata/resultsGSA/nocore_tcga_kegg_gsa_results_fisher.csv")
```
...
```{r, include=FALSE}
GSAsummaryTable(gsaRes = gsa_adj_hallmarks, save=T, file = "localdata/resultsGSA/nocore_tcga_hallmarks_gsa_results_fisher.csv")
```
...
```{r}
GSAsummaryTable(gsaRes = gsa_adj_mets, save=T, file = "localdata/resultsGSA/nocore_tcga_mets_gsa_results_fisher.csv")
```
...
```{r}
GSAsummaryTable(gsaRes =  gsa_adj_subs, save=T, file = "localdata/resultsGSA/nocore_tcga_subs_gsa_results_fisher.csv")
```
