...
#create a list with ensembl ids
...
right_join(genes_list, length, by = "ensembl_gene_id", copy = TRUE) -> gene_lenght_list

joined_CCLE %>% 
  group_by(Hugo_Symbol) %>% 
  mutate(gene_length = End_position - Start_position) %>% 
  select(Hugo_Symbol, gene_length) -> normalize_length
```
