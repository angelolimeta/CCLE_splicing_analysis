---
title: "PCA on transcript data, using original TCGA core splicing factor list"
...
arranged_core <- ggarrange(gg_transcription_disease,gg_transcription_mutated, ncol = 1, nrows=2)
# 
ggsave(filename = arranged_core, device = "png", path = "../figures/exploration/", height=20, width = 10)
```
...
ggsave("/Users/castilln/Desktop/thesis/figures/exploration/core_tcga_tsne_expression.png", device = "png", width = 23, height = 22, units = "cm", dpi = "retina")
