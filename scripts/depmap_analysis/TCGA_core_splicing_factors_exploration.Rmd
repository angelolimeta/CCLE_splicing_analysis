---
title: "Spliceosome analysis of core factors - splicing factors list from TCGA"
output: html_notebook
---

Description: analysis of core splicing factors (using list from TCGA). Generated binary heatmaps based on presence / absence of the mutation in a certain cell line.
...
ggsave("../../../figures/exploration/n_mutations_core.png", height = 5, width = 6.8)
```
...
core_hm %>% save_pdf("../../../figures/exploration/core_binary_hm.pdf", height = 12)
