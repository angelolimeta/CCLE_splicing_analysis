---
title: "PCA on transcript data, using original splicing factor mutations list"
output: html_notebook
---

Description: performed PCA on RNA-seq transcript data, separating the data in two groups: spliceosome mutated vs wt spliceosome (considering spliceosomal genes those part of the original spliceosome list made up by KEGG and HS lists).
...
conver na values to 0 
```{r}
long_CCLE_expression$TPM[is.na(long_CCLE_expression$TPM)] <- 0

sum(is.na(long_CCLE_expression$TPM))
```
