---
title: "PCA on transcript data, using original TCGA non-core splicing factor list"
...
expression_pca <- as.matrix(df_wide[3:ncol(df_wide)])
expression <- as.matrix(df_wide[,4:ncol(df_wide)])
...
arranged_no_core <- ggarrange(gg_transcription_disease,gg_transcription_mutated, ncol = 1, nrows=2)
# 
ggsave(filename = arranged_no_core, device = "png", path = "../figures/exploration/", height=20, width = 10)
```
...
ggsave("/Users/castilln/Desktop/thesis/figures/exploration/no_core_tcga_tsne_expression.png", device = "png", width = 23, height = 22, units = "cm", dpi = "retina")
